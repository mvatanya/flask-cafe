...
class NavBarTestCase(TestCase):
    ...
    def test_anon_navbar(self):
        with app.test_client() as client:
            ...
            self.assertNotIn(b'/signout', resp.data)
    ...
    def test_logged_in_navbar(self):
        with app.test_client() as client:
            ...
            self.assertNotIn(b'/login', resp.data)
            self.assertNotIn(b'/signup', resp.data)
...
class ProfileViewsTestCase(TestCase):
    ...
    def test_anon_profile(self):
        with app.test_client() as client:
            ...
            self.assertIn(b"TestCheck - This is login page", resp.data)
    ...
    def test_logged_in_profile(self):
        with app.test_client() as client:
            ...
            self.assertTrue(session.get(CURR_USER_KEY))
            self.assertIn(bytes(f'{self.user.get_full_name()}', encoding="utf-8"), resp.data)
    ...
    def test_logged_in_profile_edit(self):
        with app.test_client() as client:
            ...
            self.assertTrue(session.get(CURR_USER_KEY))
            self.assertIn(b'profile-edit-form', resp.data)
